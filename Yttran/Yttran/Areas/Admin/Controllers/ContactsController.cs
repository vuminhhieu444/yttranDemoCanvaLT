...
namespace Yttran.Areas.Admin.Controllers
{
    ...
    public class ContactsController : Controller
    {
        ...
        public ContactsController(YttranContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Phonenumber,Address,Email,Name")] Contact contact)
        {
            if (string.IsNullOrEmpty(HttpContext.Session.GetString("Admin")))
            {
                return Redirect("/Admin/Login/Index");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Phonenumber,Address,Email,Name")] Contact contact)
        {
            if (string.IsNullOrEmpty(HttpContext.Session.GetString("Admin")))
            {
                return Redirect("/Admin/Login/Index");
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            catch (Exception e)
            {
                ...
                return Redirect("/Admin/Contacts/Delete/" + id);
                throw;
            }
        }
